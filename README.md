...
The pie chart shows persantage probability of bike checkout for each group. Second plot shows the same analysis in comparison between groupes using colors.
